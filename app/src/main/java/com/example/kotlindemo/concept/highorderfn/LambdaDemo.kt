...
fun main() {
    ...
    val singleParamsLambdaSimple: (Int) -> Int = { it * 2 } // No need to specify the type of x, it can be inferred from the context and use 'it' keyword
    println("singleParamsLambdaSimple = ${singleParamsLambdaSimple(5)}")
